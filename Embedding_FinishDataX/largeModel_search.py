...
INDEX_PATH = os.path.join(USED_DATA, "large_vp_openai_cosine.index")
META_PATH  = os.path.join(USED_DATA, "large_vp_openai_metadata.parquet")  
IDMAP_JSON = os.path.join(USED_DATA, "large_vp_faiss_idmap.json")         
